...
class CuratedInteractor(models.Model):
    ...
    MedalType = models.TextChoices('InteractorType', 'protein gene mRNA synthetic')
...
class Interaction(models.Model):
    ...
    interactor_1 = models.ForeignKey(CuratedInteractor, models.DO_NOTHING, db_column='interactor_1')
    interactor_2 = models.ForeignKey(CuratedInteractor, models.DO_NOTHING, db_column='interactor_2')
